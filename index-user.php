...
<body>
  <div id="success-login">Status: USER MODE | 1914311048 - Ahmad Dhani</div>
  <form method="post">
  <input type="hidden" name="logout" value="1"/>
  <input type="submit" class="button" value="Logout"/>
  <a class="buttonPrint" href="cetak-user.php" style="text-decoration: none;" target="_blank">Cetak Data</a>
  </form>
